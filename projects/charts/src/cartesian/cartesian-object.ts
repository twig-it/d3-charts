...
export abstract class CartesianObject {
  ...
  public constructor(
    ...
    const containerSelection = select<HTMLElement, CartesianObject | undefined>(
      this.chartContainer
    );
  ...
  public abstract addPoints(
    seriesName: string,
    data: DataPoint[] | OrdinalDataPoint[],
    redraw: boolean
  ): void;
  public abstract addPoint(
    seriesName: string,
    datum: DataPoint | OrdinalDataPoint,
    redraw: boolean
  ): void;
